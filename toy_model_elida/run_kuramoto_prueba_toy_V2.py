...
data = loadmat('/home/elida/Descargas/matrices_syn_seed_1002_con ajuste.mat')
...
def run_simulation(MD_K):
    ...
    filename = directory + f'toy_con_ajuste_N{N}_K{K:.3F}_MD{MD:.3f}_seed{seed}.mat'
